# HidHideBufferOverflowException
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) → [HidHideException](./nefarius.drivers.hidhide.hidhideexception.md) → [HidHideBufferOverflowException](./nefarius.drivers.hidhide.hidhidebufferoverflowexception.md)<br>
