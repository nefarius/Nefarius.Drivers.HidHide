...
```csharp
public sealed class HidHideHandleInvalidException : HidHideException, System.Runtime.Serialization.ISerializable
```

Inheritance [Object](https://learn.microsoft.com/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/dotnet/api/system.exception) → [HidHideException](./nefarius.drivers.hidhide.exceptions.hidhideexception.md) → [HidHideHandleInvalidException](./nefarius.drivers.hidhide.exceptions.hidhidehandleinvalidexception.md)<br>
